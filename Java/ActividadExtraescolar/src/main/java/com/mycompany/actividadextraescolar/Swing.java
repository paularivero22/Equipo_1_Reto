...
public class Swing extends javax.swing.JFrame {
  private Connection getConnection() {
    ...
    private void initComponents() {
        ...
        Loginmenu.setText("Inicio de sesión");
    ...
    private void LoginAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_LoginAncestorAdded
        ...
        if (username.equals("usuario") && password.equals("contraseña")) {
            ...
            // Abre la ventana principal o realiza otras acciones
        } else {
            JOptionPane.showMessageDialog(this, "Usuario o contraseña incorrectos. Por favor, inténtelo de nuevo.");
        }
    } else if (evt.getSource() == restablecerBoton) {
        // Crear una instancia del panel CambiarContraseña
        //JPanelCambiarContraseña cambiarContraseñaPanel = new CambiarContraseña();
        ...
        // Agregar el panel CambiarContraseña al contenedor
        //container.add(cambiarContraseñaPanel);
        
        // Validar y redibujar el contenedor
        container.validate();
        container.repaint();
    }
